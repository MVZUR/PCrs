...
#define SPI3_MOSI_sensors_Pin GPIO_PIN_1
#define SPI3_MOSI_sensors_GPIO_Port GPIOC
...
#define FMPI2C1_SCL_sensors_Pin GPIO_PIN_6
#define FMPI2C1_SCL_sensors_GPIO_Port GPIOC
#define FMPI2C1_SDA_sensors_Pin GPIO_PIN_7
#define FMPI2C1_SDA_sensors_GPIO_Port GPIOC
#define GPIO_Output_relaydrvr_alarm_siren_Pin GPIO_PIN_9
#define GPIO_Output_relaydrvr_alarm_siren_GPIO_Port GPIOC
#define GPIO_Output_relaydrvr_hazard_lights_Pin GPIO_PIN_8
#define GPIO_Output_relaydrvr_hazard_lights_GPIO_Port GPIOA
#define GPIO_Output_relaydrvr_blinkers_together_Pin GPIO_PIN_9
#define GPIO_Output_relaydrvr_blinkers_together_GPIO_Port GPIOA
#define GPIO_Output_relaydrvr_lights_mode_Pin GPIO_PIN_10
#define GPIO_Output_relaydrvr_lights_mode_GPIO_Port GPIOA
#define GPIO_Output_relaydrvr_light_sel_Pin GPIO_PIN_11
#define GPIO_Output_relaydrvr_light_sel_GPIO_Port GPIOA
#define GPIO_Output_relaydrvr_stand_onoff_Pin GPIO_PIN_12
#define GPIO_Output_relaydrvr_stand_onoff_GPIO_Port GPIOA
#define SPI3_SCK_sensors_Pin GPIO_PIN_10
#define SPI3_SCK_sensors_GPIO_Port GPIOC
#define SPI3_MISO_sensors_Pin GPIO_PIN_4
#define SPI3_MISO_sensors_GPIO_Port GPIOB
